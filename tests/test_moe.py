...
def test_parse_moe_layer_structure():
    tensors = [
        TensorAddress(name="model.layers.0.input_layernorm.weight", shard="s1", dtype="F16", shape=[4096], byte_start=0, byte_end=8192, num_params=4096, size_bytes=8192),
        TensorAddress(name="model.layers.0.self_attn.q_proj.weight", shard="s1", dtype="F16", shape=[4096, 4096], byte_start=8192, byte_end=33562624, num_params=16777216, size_bytes=33554432),
        TensorAddress(name="model.layers.0.mlp.gate.weight", shard="s1", dtype="F16", shape=[64, 4096], byte_start=33562624, byte_end=34086912, num_params=262144, size_bytes=524288),
        TensorAddress(name="model.layers.0.mlp.experts.0.gate_proj.weight", shard="s1", dtype="F16", shape=[1408, 4096], byte_start=34086912, byte_end=45621248, num_params=5767168, size_bytes=11534336),
        TensorAddress(name="model.layers.0.mlp.experts.0.up_proj.weight", shard="s1", dtype="F16", shape=[1408, 4096], byte_start=45621248, byte_end=57155584, num_params=5767168, size_bytes=11534336),
        TensorAddress(name="model.layers.0.mlp.experts.0.down_proj.weight", shard="s1", dtype="F16", shape=[4096, 1408], byte_start=57155584, byte_end=68689920, num_params=5767168, size_bytes=11534336),
        TensorAddress(name="model.layers.0.mlp.shared_experts.gate_proj.weight", shard="s1", dtype="F16", shape=[1408, 4096], byte_start=68689920, byte_end=80224256, num_params=5767168, size_bytes=11534336),
    ]
...
def test_moe_sequential_expert_sweep_memory_stability():
    ...
    if device == "cuda":
        ...
        assert abs(peak_memories[-1] - peak_memories[0]) < 10.0, "Detected memory accumulation across MoE iterations"
