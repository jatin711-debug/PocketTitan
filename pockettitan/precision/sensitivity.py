...
def compute_tensor_sensitivity(tensor_addr: TensorAddress, model_meta: Optional[ModelMetadata] = None) -> TensorSensitivityScore:
    ...
    if any(k in name_lower for k in ["q_proj", "k_proj", "v_proj", "o_proj", "attn"]):
        ...
        is_boundary_layer = (layer_num <= 1) or (model_meta and layer_num >= model_meta.num_hidden_layers - 2)
